  ...
  <div class="wrap">
	...
	<?php 
		if (isset($_GET['cId'])) {
			...
			$delcompaire = $product->deleteCompaireLogout($id);
			Session::destroy();
		}
	?>
		   <div class="login">
...
<div class="menu">
	<ul id="dc_mega-menu-orange" class="dc_mm-orange">
	  ...
	  <?php 
	  	$cartCheck = $cart->checkCartTable();
	  	if ($cartCheck) { ?>
	  	<li><a href="cart.php">Cart</a></li>
	  <?php	} ?>
	  <?php
	  	$id = Session::get("cusid"); 
	  	$orderCheck = $order->checkOrder($id);
	  	if ($orderCheck) { ?>
	  ...
	  <?php
	  	$id = Session::get("cusid"); 
	  	$compaireCheck = $product->checkCompaire($id);
	  	if ($compaireCheck) { ?>
	  <li><a href="compaire.php">Compare</a> </li>
	  <?php	} ?>
	  <?php
	  	$id = Session::get("cusid"); 
	  	$wishlistCheck = $product->checkWishlist($id);
	  	if ($wishlistCheck) { ?>
